...
def _masthead(statement, width):
    ...
    left = Table(
        [[Mark(34), [Paragraph("KaamKoRecord", WORDMARK), Paragraph("Hours &amp; pay statement", TAGLINE)]]],
...
def _furniture(canvas, doc):
    ...
    canvas.drawString(EDGE + 12, top + 1, "KaamKoRecord")
    ...
    canvas.setFillColor(MUTED)
    canvas.drawString(EDGE, 9.5 * mm, "Generated by KaamKoRecord from your own timesheet")

...
def _masthead(statement, width):
    ...
    left = Table(
        [[Mark(34), [Paragraph("MeroKaam", WORDMARK), Paragraph("Hours &amp; pay statement", TAGLINE)]]],
...
def _furniture(canvas, doc):
    ...
    canvas.drawString(EDGE + 12, top + 1, "MeroKaam")
    ...
    canvas.setFillColor(MUTED)
    canvas.drawString(EDGE, 9.5 * mm, "Generated by MeroKaam from your own timesheet")

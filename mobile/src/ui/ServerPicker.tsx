      ...
      {open ? (
        <View style={[styles.panel, { backgroundColor: t.surface, borderColor: t.dark ? t.line : "transparent" }]}>
          ...
          <Text style={{ color: t.muted, fontSize: 13, lineHeight: 18 }}>
            Where MyWork is running: the site's address, or your laptop's on the same Wi-Fi while developing (for example 192.168.0.11:8000). Leave it empty for this build's own: {defaultServer().replace(/^https?:\/\//, "")}.
          </Text>

/**
 * The month (templates/timeclock/calendar.html): a grid with the hours
 * worked on each day and a line under it showing how the day divided
 * between jobs, the key below, and the shifts behind whichever day is
 * tapped.
 */
...
import { Card, ErrorBanner, IconButton, Loading, Page, PageTitle, Screen, Segments, useLayout } from "@/ui";
  ...
  return (
    <Screen>
      <Page>
        ...
        <Segments value="calendar" onChange={(v) => v === "list" && goBack()} options={[{ value: "list", label: "List" }, { value: "calendar", label: "Calendar" }]} />

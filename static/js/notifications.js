...
(function () {
  ...
  function initToggle() {
    ...
    if (!supported) {
      if (iOS && !installed) {
        say(
          "To get notifications on an iPhone, add KaamKoRecord to your Home Screen " +
            "first: tap Share, then Add to Home Screen, and open it from there.",
          null
        );
      } else {
        say("This browser can't show notifications when KaamKoRecord is closed.", null);
      }
      return;
    }
    ...
    if (Notification.permission === "denied") {
      say(
        "Notifications are blocked for KaamKoRecord. Turn them back on in your " +
    ...
    input.addEventListener("change", function () {
      ...
      work
        ...
        .then(function () {
          ...
          if (Notification.permission === "denied") {
            say("Notifications are blocked for KaamKoRecord in this browser.", null);
          } else {
            settle();
          }
        });
